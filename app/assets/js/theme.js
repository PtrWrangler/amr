...
function language_handler(){
	...
	// get user's region and extract language from beginning
	...
	if (typeof(Storage) !== "undefined") {
		...
		if (localStorage.language) {
			...
			{
				alert("language not supported, storing french");
				localStorage.language = "fr";
			}
		}
		else
		{
			alert("language not set yet, storing region's lang");
			localStorage.language = lang;
		}
		
		//localStorage.setItem("lang", "Smith");
	} else {
		//No Web Storage support.. just reroute fr
	}
}
